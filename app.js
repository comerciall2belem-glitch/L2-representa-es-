...
const key='l2one_state_v2', defaults={clients:[],visits:[],orders:[],tasks:[],goals:[],routes:[],prices:[],officeProcesses:[],officeActions:[],officeCommercial:[],officeAdministrative:[],officeRituals:[],officeRoles:[],officeFinance:[],officeBudget:[],officeMonthlyClose:[],user:'Ana Paula',server:'',token:'',mustChangePassword:false,syncAt:'',pending:[]};
