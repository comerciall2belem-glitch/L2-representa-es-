...
const key='l2one_state_v2', defaults={clients:[],visits:[],orders:[],tasks:[],goals:[],routes:[],user:'Ana Paula',server:'',token:'',mustChangePassword:false,syncAt:'',pending:[]};
