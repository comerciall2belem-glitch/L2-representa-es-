...
namespace = {}
exec(compile(ast.Module(body=[FUNCTIONS["valid_cnpj"], FUNCTIONS["normalize_uf"], FUNCTIONS["price_table_matches_client"]], type_ignores=[]), "<fiscal>", "exec"), namespace)
...
class FiscalValidationTests(unittest.TestCase):
    ...
    def test_order_table_must_match_customer_state(self):
